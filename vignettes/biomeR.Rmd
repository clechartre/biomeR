...
biomeR is an R frontend that calls the Julia package [Biome.jl](https://github.com/clechartre/Biome.jl) through [JuliaCall](https://github.com/JuliaInterop/JuliaCall). 
The workflow is:
